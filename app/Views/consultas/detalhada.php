            ...
            <fieldset class="border p-4">
                ...
                <div class="row">
                    <div class="col col-12">
                        ...
                        <label class="textoConsultaDetalhada">00:00:00</label>
                    </div>
                </div>
                <div class="row">
                    <div class="col col-12">
                        <label class="tituloConsultaDetalhada">Observação (Emergência)</label>
                        <textarea style="background-color: white;"class="form-control" rows="5" readonly>
                            <?= $dados["operacao"][0]->obs_emergencia ?>
                        </textarea>
                    </div>
                </div>
                <div class="row">
