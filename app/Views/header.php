        ...
        <?php if($helper->sessionValidate()){?>
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav me-auto mb-2 mb-sm-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link fonteMenu dropdown-toggle <?= $helper->verificaLinkAtivo(['empresa/nova', 'empresa/consulta', 'veiculo/novo', 'veiculo/consulta', 'pessoa/nova', 'pessoa/consulta']) ?>" href="#" id="dropdown03" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <figcaption>Empresas</figcaption>
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="dropdown03">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link fonteMenu dropdown-toggle <?= $helper->verificaLinkAtivo(['portaria/novo', 'portaria/consulta', 'portaria/portaria_usuario']) ?>" href="#" id="dropdown03" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <figcaption>Portarias</figcaption>
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="dropdown03">
