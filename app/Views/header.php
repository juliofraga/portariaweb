...
<nav class="navbar navbar-expand-sm navbar-dark fixed-top" style="background-color:black">
    <div class="container-fluid">
        ...
        <?php } ?>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbar-menu-admin" aria-controls="navbar-menu-admin" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
        </button>
        <?php if($helper->sessionValidate()){?>
            <div class="collapse navbar-collapse" id="navbar-menu-admin">
                <ul class="navbar-nav me-auto mb-2 mb-sm-0">
                    ...
                    <?php if($_SESSION['pw_tipo_perfil'] != md5("Operador")){ ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link fonteMenu dropdown-toggle <?= $helper->verificaLinkAtivo(['configuracoes', 'importador']) ?>" href="#" id="dropdown03" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdown03">
                                <li><a class="dropdown-item fonteMenu" href="<?= URL ?>/configuracoes">Configurações</a></li>
                                <li><a class="dropdown-item fonteMenu" href="<?= URL ?>/importador">Importador</a></li>
                            </ul>
                        </li>
                    <?php } ?>
